...
### 步骤
 ...
 3. 修改 `README.md`，将 `run-2-agoal/hero-v2r` 替换为自己的内容（如 `example/demo`）

> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/run-2-agoal/hero-v2r)
